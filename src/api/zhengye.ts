...
const mapDashboard = (data: any): DashboardData => ({
  ...
  max_commission_rate: Number(data?.entry_rate ?? data?.my_rate ?? 0),
  upgrade_condition: data?.upgrade_condition || '',
  paid_commission: formatMoney(data?.today_earnings),
  pending_commission: formatMoney(data?.today_earnings),
  total_commission: formatMoney(data?.total_earnings),
  direct_partners: Number(data?.total_partners ?? 0),
  total_orders: Number(data?.total_orders ?? 0),
  total_sales: formatMoney(data?.total_earnings),
...
const mapStats = (data: any): StatsData => ({
  today: {
    total_sales: formatMoney(data?.total_earnings),
    self_sales: formatMoney(data?.total_earnings),
    net_sales: formatMoney(data?.total_earnings),
    self_net_sales: formatMoney(data?.total_earnings),
    net_settlement: formatMoney(data?.total_earnings),
    net_settlement_original: formatMoney(data?.total_earnings),
    net_settlement_refund: '0.00',
    network_orders: Number(data?.total_orders ?? 0),
    self_orders: Number(data?.total_orders ?? 0),
    new_channels: 0,
    refund_amount: '0.00',
    self_refund: '0.00',
  },
  ...
  commission_rate: 0,
  discount_rate: 5,
  paid_settlement: '0.00',
  pending_settlement: formatMoney(data?.total_earnings),
